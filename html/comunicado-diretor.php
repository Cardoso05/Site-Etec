...
<html lang="pt-br">
    ...
    <head>
        ...
        <!-- Css -->
        <link rel="stylesheet" type="text/css" href="../css/comunicado-diretor.css">
    ...
    <body>
        ...
        <div class="conteudo-pagina">
            ...
            <div class="img-comunicado">

                <a href="index.php"><img src="../img/img-comunicado/icones/icone-3.png"></a>

            </div>
            
            <div>

                <h3 class="titulo-1">COMUNICADO DIRETOR</h3>

            </div>

            <div>

                <iframe class="video-responsive" src="https://www.youtube.com/embed/fpbgHv6tb3A" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
